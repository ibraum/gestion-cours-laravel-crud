...
@section('content');
<h3 class="mt-5">Listes des etudiants du cour <h2 class="text-danger fw-bolder">{{$cour->libelCour}}</h2> </h3>
    ...
    <div class="col-md-12">
        ...
        <div class="card border border-3">
            <div class="card-header">
                <a href="{{route("cours.index")}}" class="btn btn-primary float-end">&larr; retour</a>
            </div>
            <div class="card-body">
